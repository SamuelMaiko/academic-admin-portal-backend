...
import TableRowRegistrationCodes from "./TableRowRegistrationCodes";
import { useNavigate } from "react-router-dom";

const TableRegistrationCodes = () => {
      ...
      <Table showCheckbox={false} hoverable="true" className="">
        <TableCaption>
          <div className="my-5 flex items-center justify-between px-6">
            ...
            <Button
              onClick={() => navigate("/reg-codes/create")}
...
export default TableRegistrationCodes;
