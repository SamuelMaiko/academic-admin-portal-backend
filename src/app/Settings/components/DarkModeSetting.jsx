    ...
    <div className=" bg-neutral-100 rounded-lg mt-3 dark:bg-darkMode-body dark:text-darkMode-text">
      ...
      <div className="pl-2 pb-2">
        <label className="inline-flex items-center relative">
          ...
          after:left-[5px] active:after:w-[50px] peer-checked:after:left-[80px]
          ...
          <svg
            ...
            className="fill-white peer-checked:opacity-60 absolute w-4 h-4 left-[13px] cursor-pointer"
          >
          ...
          <svg
            ...
            id="Layer_1"
            xmlns="http://www.w3.org/2000/svg"
            className="fill-black opacity-60 peer-checked:opacity-70 peer-checked:fill-white absolute w-6 h-4 right-[13px] cursor-pointer"
          >
