    ...
    <form className="pt-5 w-[58%] pb-14">
      ...
      <div className="mt-1 mb-5">
        ...
        <div className="flex items-center gap-4">
          <input
            type="text"
            className="flex mt-2 w-[11rem] rounded-md border border-gray-300 bg-transparent px-3
            py-3 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 text-neutral-500
            focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
            name="user"
            value={user}
          ...
          <Eye
            size={20}
            className={`text-yellow-400 ${user == "None" ? "hidden" : ""}`}
          />
        </div>
      </div>
...
export default ChangeRegCodeForm;
